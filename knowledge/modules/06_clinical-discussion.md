# Preparing for a healthcare discussion

## Theory Tags
- HBM: cue to action — offer one concrete next step.
- PMT: response efficacy — explain why preparing for a healthcare
  discussion can be useful.
- PMT: self-efficacy — reinforce the user's ability to take a small,
...
- Avoid implying that a healthcare discussion will necessarily lead to
  testing, treatment, or another procedure.
